# Generated by Django 3.1.5 on 2021-01-29 00:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grocerylist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grocery_set', to='grocery_list.grocerylist')),
            ],
        ),
        migrations.CreateModel(
            name='GroceryItem',
            fields=[
                ...
                ('grocery_list_week', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grocery_item_set', to='grocery_list.grocerylistweek')),
            ],
        ),
    ]
